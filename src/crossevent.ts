...
export function dispatchMouseEventFromTouchEvent(event: TouchEvent): void {
    ...
    (mouseEvent as any).isTouch = true;
...
export function onTapClick(element: HTMLElement, callback: (event: Event) => void): void {
    ...
    const clickHandler = (event: MouseEvent) => {
        ...
        if ((event as any).isTouch || tapFlag) {
